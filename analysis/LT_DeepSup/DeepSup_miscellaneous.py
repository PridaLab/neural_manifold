...
perc_sup =  [0.94, 0.95, 0.48, 0.71, 0.02, 0.00]
perc_deep = [0.48, 0.22, 0.38, 0.47, 0.43, 0.67]
perc_total = [0.75, 0.64, 0.43, 0.63, 0.14, 0.21]
rotation_pd['perc_sup'] = perc_sup
rotation_pd['perc_deep'] = perc_deep
rotation_pd['perc_total'] = perc_total
rotation_pd['dist_change'] = rotation_pd['dist_CNO']/rotation_pd['dist_veh']#(rotation_pd['dist_CNO']- rotation_pd['dist_veh'])/rotation_pd['dist_veh']


fig, ax = plt.subplots(3, 3, figsize=(6,6))

b = sns.scatterplot(x='perc_sup', y='dist_veh',data=rotation_pd, hue='strain', ax = ax[0,0])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_sup"].to_list(),rotation_pd["dist_veh"].to_list())
ax[0,0].plot([0,1], [intercept, slope+intercept], 'k--')
ax[0,0].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
b = sns.scatterplot(x='perc_deep', y='dist_veh',data=rotation_pd, hue='strain', ax = ax[0,1])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_deep"].to_list(),rotation_pd["dist_veh"].to_list())
ax[0,1].plot([0.2,0.7], [intercept, slope+intercept], 'k--')
ax[0,1].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
b = sns.scatterplot(x='perc_total', y='dist_veh',data=rotation_pd, hue='strain', ax = ax[0,2])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_total"].to_list(),rotation_pd["dist_veh"].to_list())
ax[0,2].plot([0,1], [intercept, slope+intercept], 'k--')
ax[0,2].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")


b = sns.scatterplot(x='perc_sup', y='dist_CNO',data=rotation_pd, hue='strain', ax = ax[1,0])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_sup"].to_list(),rotation_pd["dist_CNO"].to_list())
ax[1,0].plot([0,1], [intercept, slope+intercept], 'k--')
ax[1,0].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
b = sns.scatterplot(x='perc_deep', y='dist_CNO',data=rotation_pd, hue='strain', ax = ax[1,1])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_deep"].to_list(),rotation_pd["dist_CNO"].to_list())
ax[1,1].plot([0.2,0.7], [intercept, slope+intercept], 'k--')
ax[1,1].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
b = sns.scatterplot(x='perc_total', y='dist_CNO',data=rotation_pd, hue='strain', ax = ax[1,2])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_total"].to_list(),rotation_pd["dist_CNO"].to_list())
ax[1,2].plot([0,1], [intercept, slope+intercept], 'k--')
ax[1,2].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")


b = sns.scatterplot(x='perc_sup', y='dist_change',data=rotation_pd, hue='strain', ax = ax[2,0])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_sup"].to_list(),rotation_pd["dist_change"].to_list())
ax[2,0].plot([0,1], [intercept, slope+intercept], 'k--')
ax[2,0].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")

b = sns.scatterplot(x='perc_deep', y='dist_change',data=rotation_pd, hue='strain', ax = ax[2,1])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_deep"].to_list(),rotation_pd["dist_change"].to_list())
ax[2,1].plot([0.2,0.7], [intercept, slope+intercept], 'k--')
ax[2,1].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
b = sns.scatterplot(x='perc_total', y='dist_change',data=rotation_pd, hue='strain', ax = ax[2,2])
slope, intercept, r_value, p_value, std_err = stats.linregress(rotation_pd["perc_total"].to_list(),rotation_pd["dist_change"].to_list())
ax[2,2].plot([0,1], [intercept, slope+intercept], 'k--')
ax[2,2].set_title(f"p-value: {p_value:.4f} - r-value: {r_value:.4f}")
plt.tight_layout()

veh_distance = rotation_pd["dist_veh"].to_list()
cno_distance = rotation_pd["dist_CNO"].to_list()

y = veh_distance + cno_distance
x = ['veh']*len(veh_distance) +['cno']*len(cno_distance)
...
veh_shapiro = shapiro(veh_distance)
cno_shapiro = shapiro(cno_distance)

if veh_shapiro.pvalue<=0.05 or cno_shapiro.pvalue<=0.05:
    print(f'ks-test distance:',stats.ks_2samp(veh_distance, cno_distance))
else:
    print(f't-test distance:', stats.ttest_rel(veh_distance, cno_distance))
