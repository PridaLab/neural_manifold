...
class StatisticModel:
    ...
    def compute_distance(self):
        ...
        self.remap_dist = self.inter_dist/np.mean((self.intra_dist_pre, self.intra_dist_rot))
        ...
        self.plane_remap_dist =  self.plane_inter_dist/np.mean((self.ellipse_pre_perimeter, self.ellipse_rot_perimeter))
